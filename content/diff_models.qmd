...
The diffusion model's central principle is the training on a sequence of gradually noised images. Here's the updated snippet with the two reasons for step-by-step noise addition included:
