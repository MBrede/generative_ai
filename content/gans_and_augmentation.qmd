...
While the rest of the paper goes into mathematical depth that is not really recommendable for the casual reader, the basic concept behind it is surprisingly simple. The following figure illustrates the concept:
