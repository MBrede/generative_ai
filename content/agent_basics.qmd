...
### Tools
Functions the agent can call – this is where the “real work” happens: data loading, statistics, plotting, web search, calling another API, …
...
5. Generates a structured EDA report (e.g. “Data overview”, “Key distributions”, “Missing values”, “First hypotheses”).
...
3. Test the agent with several prompts and observe when it uses tools, when it doesn’t, and where it struggles. 
...
1. Discuss: for our EDA example, does it make sense to use an agent? Or would a pipeline be sufficient? Maybe even better?
2. Implement your agent from above as a pipeline. 
3. Upload your Notebook to Moodle. 
