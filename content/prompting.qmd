...
The temperatur, indicated as a float between 0 and 1, is used to modulate the probabilities of the next token. This is done by adding a $\frac{1}{Temp}$ factor to the model-outputs before applying the softmax.
