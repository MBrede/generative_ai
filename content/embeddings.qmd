...
Install the qdrant[fastembed] python-sdk.
...
Add the first 200 entries to each of these collections. Use qdrants [fastembemd](https://qdrant.tech/articles/fastembed/) to do this.
