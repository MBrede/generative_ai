---
toc-title: '![](../imgs/rag.png){width=240px}<br> <h3>Embedding-based agent-systems</h3>'
---
...
Add the first 200 entries to each of these collections. Use qdrants [fastembemd](https://qdrant.tech/articles/fastembed/)-integration to do this.
...
![Illustration of a RAG-system.](../imgs/rag.png){#fig-rag .enlarge-onhover}
